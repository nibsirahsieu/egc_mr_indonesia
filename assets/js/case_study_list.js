...
$(function() {
    ...
    var dt = $('#case_studies_table').DataTable({
        "layout": {
            "topStart": null,
        ...
        "order": false,
        "ajax": {
            "url": Router.generate('app_case_study_ajax_list')
        },
        "columns": [
            {"data": "Title", "orderable": false},
            {"data": "Client", "orderable": false},
            {"data": "Status", "orderable": false},
            {"data": "PublishedAt", "orderable": false, 'class': 'text-no-wrap'},
            {"data": "Actions", "orderable": false, 'class': 'text-end text-no-wrap'}
        ]
    });
